...
def create_default_json(output_path):
    """
    建立預設的 JSON 檔案，包含日文-中文對照的預設資料
    """
    default_data = [{"jp": "ミカ", "zh": "米卡"},{"jp": "レイプ", "zh": "強姦"},{"jp": "パイズリ", "zh": "乳交"},{"jp": "チンポ", "zh": "陰茎"}, {"jp": "ペニス", "zh": "陰茎"},{"jp": "オマ○コ", "zh": "陰部"},{"jp": "マルコ", "zh": "陰部"},{"jp": "マ○コ", "zh": "陰部"}, {"jp": "アカツキ学園", "zh": "曉學園"}, {"jp": "シンジ", "zh": "慎司"}, {"jp": "カナ", "zh": "香奈"}, {"jp": "ユウ", "zh": "悠"}]
